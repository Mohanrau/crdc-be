...
@section('content')
    <table border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="header center">TAX INVOICE<br/>GST Registration No: 19-9701982-Z</td>
        </tr>
    </table>
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            <th class="data0 dataHeader">No</th>
            <th class="data1 dataHeader">TOS</th>
            <th class="data2 dataHeader">Product Code</th>
            <th class="data3 dataHeader">Description</th>
            <th class="data4 dataHeader">Qty</th>
            <th class="data5 center dataHeader">Total CV</th>
            <th class="data6 right dataHeader">Unit Price (SGD)</th>
            <th class="data7 right dataHeader">Sub-Total (SGD)</th>
            <th class="data8 right dataHeader">Discount</th>
            <th class="data9 right dataHeader">GMP (Excl GST) (SGD)</th>
            <th class="data10 right dataHeader">GST {{ $taxRate }}% (SGD)</th>
            <th class="data11 right dataHeader">GMP (Incl GST) (SGD)</th>
        </tr>
    ...
    <div class="signature">
        ...
        <div class="wrapCol">Distributors' & Customer's data & information will be kept confidential and used solely for the purposes as stated in our Personal Data Protection Notice shown in our website at www.elken.com/sg</div>
        <div class="breaker"></div>
        ELKEN (SINGAPORE) PTE LTD (19-9701982-Z)<br/>
        1, Sims Lane, #03-03, #03-04 Singapore 387355<br/>
        Tel: 026746 4911&nbsp;&nbsp;&nbsp;Fax: 026741 9870&nbsp;&nbsp;&nbsp;WebSite: www.elken.com/sg&nbsp;&nbsp;&nbsp;Email: customerservice.sg@elken.com 
    </div>
@endsection