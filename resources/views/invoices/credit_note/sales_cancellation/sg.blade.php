...
@section('content')
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="center smaller">GST Registration No: 19-9701982-Z</td>
        </tr>
    </table>
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="data6 right dataHeader">Unit Price (SGD)</td>
            <td class="data7 right dataHeader">Sub-Total (SGD)</td>
            <td class="data8 right dataHeader">Discount</td>
            <td class="data9 right dataHeader">GMP (Excl GST) (SGD)</td>
            <td class="data10 right dataHeader">GST {{$taxRate}}% (SGD)</td>
            <td class="data11 right dataHeader">GMP (Incl GST) (SGD)</td>
        </tr>
