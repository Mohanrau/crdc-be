...
@section('content')
    <table border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="header center">HONG KONG</td>
        </tr>
        <tr>
            <td class="center smaller">
                Room 3601, 36/F. ACE Tower Windsor House, 311 Gloucester Road Causeway Bay, Hong Kong<br/>
                Tel: +852 3181 5000&nbsp;&nbsp;&nbsp;&nbsp;Fax: +852 3181 5050<br/>
                <hr>
            </td>
        </tr>
        <tr>
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="data6 right dataHeader">Unit Price (HKD)</td>
            <td class="data7 right dataHeader">Sub-Total (HKD)</td>
        </tr>
