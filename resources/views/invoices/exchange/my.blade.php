...
@section('content')
    <table border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="header center"><h3>MALAYSIA</h3><br/>
                20, Bangunan Elken, jalan 1/137C, Batu 5 Jalan Kelang Lama 58000 Kuala Lumpur<br/>
                Tel: 0379858888&nbsp;&nbsp;&nbsp;&nbsp;Fax: 0377859284<br/>
            </td>
        </tr>
        <tr>
            <td class="header right">GST ID No: 000182603776</td>
        </tr>
        <tr>
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="data7 dataHeader right">Total Excl. GST</td>
            <td class="data8 dataHeader right">Total GST</td>
