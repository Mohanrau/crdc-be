    ...
    <table cellpadding="0" cellspacing="0">
        ...
        @foreach($esacVouchers as $discount)
            <tr>
                ...
                <td class="dataRow data6 right"></td>
                <td class="dataRow data7 right"></td>
                <td class="dataRow data8 right">({{ number_format($discount->voucher_value, 2) }})</td>
                <td class="dataRow data9 right"></td>
                <td class="dataRow data10 right">({{ number_format($discount->voucher_value, 2) }})</td>
            </tr>
        @endforeach
        <tr>
            <td colspan="10">
