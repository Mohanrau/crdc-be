...
<style type="text/css">
    ...
    .summaryTbl2{width: 400px;margin-left: 10px;margin-top: 20px;}
    .summaryTbl{margin-top: 0px;}
    .summary12{width:80%;padding-left: 10px}
    .summary22{width:20%;text-align:right;padding-right: 20px}
...
@section('content')
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            <th class="data1 dataHeader left">No</th>
            <th class="data2 dataHeader left">Product Code</th>
            <th class="data3 dataHeader left">Description</th>
        ...
        <tr>
            <td colspan="8">
                @include('invoices.partials.summaryTH', $summary)
            </td>
        </tr>
