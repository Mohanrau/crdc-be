...
@section('content')
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="header2 header center dotted-underline">CASH SALES</td>
        </tr>
        <tr>
            <td class="header2"></td>
    ...
    <table cellpadding="0" cellspacing="4">
        ...
        <tr>
            ...
            <td rowspan="2" class="info3 top">Delivery Method</td>
            <td rowspan="2" class="divider top">:</td>
            <td rowspan="2" class="info4 top wrapCol">{{ $basic['delivery'] }}<br>{{ $basic['collection']? '('. $basic['collection'] .')' : "" }}</td>
        </tr>
        <tr>
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="data6 dataHeader right">GROSS UNIT PRICE</td>
            <td class="data7 dataHeader"></td>
            <td class="data8 dataHeader right">TOTAL AMT</td>
        </tr>
        ...
        <tr>
            ...
            <td class="data4 dataRow right"></td>
            <td class="data5 dataRow center"></td>
            <td class="data6 dataRow right"></td>
            <td class="data7 dataRow center">PHP</td>
            <td class="data8 dataRow right">({{ number_format($discount->voucher_value, 2) }})</td>
        </tr>
        @endforeach
        <tr>
            <td colspan="8">
    ...
    <div class="signature">
        <table cellpadding="0" cellspacing="5">
            ...
            <tr>
                ...
                <td style="width: 20%"></td>
                <td class="footer-line">Received the Above Goods<br/>in good order and condition</td>
            </tr>
        </table>
        <div class="breaker"></div>
        <div class="center" style="width: 100%">
            IT IS NOT AN OFFICIAL RECEIPT OR TAX INVOICE
        </div>
    </div>
@endsection