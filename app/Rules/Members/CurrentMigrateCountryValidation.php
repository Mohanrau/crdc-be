...
class CurrentMigrateCountryValidation implements Rule
{
    private $memberRepositoryObj, $userId;

    /**
     * CurrentMigrateCountryValidation constructor.
     *
    ...
    public function passes($attribute, $value)
    {
        ...
        return ($member->country_id == $value) ? false : true;
    }
    ...
    {
        return __('message.member-migrate.different-country');
    }
}
