...
class CurrentEnrollementRankValidation implements Rule
{
    private $memberRepositoryObj, $userId;

    /**
     * CurrentEnrollementRankValidation constructor.
     *
    ...
    public function passes($attribute, $value)
    {
        ...
        return ($member->enrollment_rank_id == $value) ? false : true;
    }
    ...
    {
        return __('message.member-rank.different-enrollment-rank');
    }
}
