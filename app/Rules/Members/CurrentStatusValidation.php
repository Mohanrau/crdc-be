...
class CurrentStatusValidation implements Rule
{
    private $memberRepositoryObj, $userId;

    /**
     * CurrentStatusValidation constructor.
     *
    ...
    public function passes($attribute, $value)
    {
        ...
        return ($member->status_id == $value) ? false : true;
    }
    ...
    {
        return __('message.member-status.different-status');
    }
}
